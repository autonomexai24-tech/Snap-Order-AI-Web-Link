      ...
      <div className="w-full">
            ...
            {items.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  <TableCell className="font-bold text-sm text-tpl-secondary max-w-[220px] py-5">
                    {item.description}
                  </TableCell>
                  ...
                  <TableCell className="text-right text-[14px] tabular-nums py-5 pr-4 font-mono font-bold text-tpl-secondary">
                    {formatINR(lineTotal)}
                  </TableCell>
                </TableRow>
              )
        ...
        <div className="flex justify-end px-5 py-4 bg-white border-b border-slate-200">
          <div className="flex items-center gap-8">
            ...
            <span className="text-[16px] font-extrabold tabular-nums w-32 text-right font-mono text-tpl-secondary">
              {formatINR(subTotal)}
            </span>
          </div>
        </div>
